...
class Taxonomy_Helper {
	...
	public function register( $singular_name, $plural_name = '' ) {
		...
		$this->items[ $this->id ]['object_type']    = 'post';
		$this->items[ $this->id ]['args']           = [];
		$this->items[ $this->id ]['args']['labels'] = [];
		$this->items[ $this->id ]['singular_name']  = $singular_name;
		$this->items[ $this->id ]['plural_name']    = $plural_name;
	...
	public function set_id( $tax_key ) {
		$this->items[ $this->id ]['tax_key'] = $tax_key;
		return $this;
	}
	...
	public function set_labels( $array = [] ) {
		...
		foreach ( $array as $key => $value ) {
			$this->items[ $this->id ]['args']['labels'][ $key ] = $value;
		}
	...
	public function set_description( $description ) {
		$this->items[ $this->id ]['args']['description'] = $description;
		return $this;
	}
	...
	public function set_public( $is_public = true ) {
		$this->items[ $this->id ]['args']['public'] = $is_public;
		return $this;
	}
	...
	public function set_private() {
		$this->items[ $this->id ]['args']['public'] = false;
		return $this;
	}
	...
	public function set_hierarchical( $hierarchical = true ) {
		$this->items[ $this->id ]['args']['hierarchical'] = $hierarchical;
		return $this;
	}
	...
	public function show_ui( $is_shown = true ) {
		$this->items[ $this->id ]['args']['show_ui'] = $is_shown;
		return $this;
	}
	...
	public function hide_ui() {
		$this->items[ $this->id ]['args']['show_ui'] = false;
		return $this;
	}
	...
	public function show_admin_column( $is_shown = true ) {
		$this->items[ $this->id ]['args']['show_admin_column'] = $is_shown;
		return $this;
	}
	...
	public function hide_admin_column() {
		$this->items[ $this->id ]['args']['show_admin_column'] = false;
		return $this;
	}
	...
	public function set_argument( $arg_name, $arg_value ) {
		$this->items[ $this->id ]['args'][ $arg_name ] = $arg_value;
		return $this;
	}
	...
	public function set_menu_name( $menu_name ) {
		$this->items[ $this->id ]['menu_name'] = $menu_name;
		return $this;
	}
	...
	public function add_to_object_type( $object_type, $hook = 'init' ) {
		$this->items[ $this->id ]['object_type'] = $object_type;
