...
class Metabox_Helper {
	...
	public function set_title( $title ) {
		$this->items[ $this->id ]['title'] = $title;
		return $this;
	}
	...
	public function render_display( $display_callback ) {
		$this->items[ $this->id ]['display_callback'] = $display_callback;
		return $this;
	}
	...
	public function add_to_screen( $screen ) {
		$this->items[ $this->id ]['screen'] = $screen;
		return $this;
	}
	...
	public function set_screen_context( $screen_context = 'advanced' ) {
		$this->items[ $this->id ]['screen_context'] = $screen_context;
		return $this;
	}
	...
	public function set_context_priority( $context_priority = 'default' ) {
		$this->items[ $this->id ]['context_priority'] = $context_priority;
		return $this;
	}
	...
	public function set_callback_args( $callback_args = null ) {
		$this->items[ $this->id ]['callback_args'] = $args;
		return $this;
	}
	...
	public function save() {
		...
		$title            = $this->items[ $this->id ]['title'];
		$display_callback = $this->items[ $this->id ]['display_callback'];
		$screen           = $this->items[ $this->id ]['screen'];
		$screen_context   = isset( $this->items[ $this->id ]['screen_context'] ) ? $this->items[ $this->id ]['screen_context'] : 'advanced';
		$context_priority = isset( $this->items[ $this->id ]['context_priority'] ) ? $this->items[ $this->id ]['context_priority'] : 'default';
		$callback_args    = isset( $this->items[ $this->id ]['callback_args'] ) ? $this->items[ $this->id ]['callback_args'] : null;
	...
	public function set_submission_callback( $submission_callback, $submission_hook = 'save_post' ) {
		$this->items[ $this->id ]['submission_callback'] = $submission_callback;
		$this->items[ $this->id ]['submission_hook']     = $submission_hook;
		return $this;
	}
